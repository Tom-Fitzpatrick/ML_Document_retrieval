...
DATASET_PATH = "dataset8.csv"
OUTPUT = "found_syllabi_model8.csv"
JSON = "found_json_model8.json"
CRAWL_PDFS = False
BUILD_SET = False
FIRST_RUN = False
...
if SVM_OVER_FOREST:
	if TEST_CLASSIFIER:
		print(svm_classifier.test_model(DATASET_PATH, False))
	model, vectorizer = svm_classifier.train_model(DATASET_PATH, False)
else:
	if TEST_CLASSIFIER:
